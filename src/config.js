...
let demoUser = {
    ...
    'mail': 'notvalid@csc.fi', // should map from shib-mail
    ...
    'organization': {code:'00000', name: 'Tuntematon', email:'notvalid@csc.fi'}, // should map from shib-group where split(;) array item is '@...'
